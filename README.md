...
**Primary practice:** Long-form reporting interface

## What I built

A report interface uses repeated article summaries, grid composition, focus styling, and status-oriented visual hierarchy to organize information-heavy content.
